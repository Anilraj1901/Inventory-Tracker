...
exports.create = async function (req, res) {
	try {
		logger.RaiseLogEvent('api/products/create', 'request', req.body, `Requested from ${req.user.id}`);
...
exports.update = async function (req, res) {
	try {
		logger.RaiseLogEvent('api/products/update', 'request', req.body, `Requested from ${req.user.id}`);
...
exports.delete = async function (req, res) {
	try {
		logger.RaiseLogEvent('api/products/delete', 'request', req.body, `Requested from ${req.user.id}`);
		...
		logger.RaiseLogEvent('api/product/delete', 'error', err, `Data ${JSON.stringify(req.params.id)}`);
		return res.send({ success: false, message: 'Error fetching product' });
	}
}
